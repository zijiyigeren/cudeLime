  ...
  <div class="box">
    <div class="wrap">
      ...
      <div :class="!myStyles ? 'el-main':''"
           :style="{
             padding: isComing!=0 ? '10px':0,
             width: '100%'
           }"
      >
        <div :class="!myStyles?'formClass':''" v-if="!myStyle">
          <div style="display: flex;align-items: center;">
            <el-form v-if="isComing!=0" label-width="82px" :inline="true" :model="formInline"
                     class="report_demo_form" style="flex: 1;" size="small">
              <div style="display: flex;justify-content: space-between;">
                ...
                <el-form-item label="报告编号 : " style="width:19%">
              ...
              <el-collapse-transition>
                <div v-show="show">
                  <div style="display: flex;justify-content: space-between;padding-top: 20px;">
                    ...
                    <div style="width:19%"><!-- 占位 --></div>
                    <div style="width:19%"><!-- 占位 --></div>
                  </div>
                </div>
              </el-collapse-transition>
            </el-form>
            <div style="min-width: 55px;" class="display">
              <el-button v-if="showbut==0" @click="clickshowbut(1)" type="text" style="color:#32AFF0;border: none;">
                收起 <i class="el-icon-arrow-up"></i>
              </el-button>
              <el-button v-if="showbut!=0" @click="clickshowbut(0)" type="text" style="color:#32AFF0;border: none;">
                展开 <i class="el-icon-arrow-down"></i>
              </el-button>
            </div>
          </div>
          <el-row class="myReportD" style="padding-top: 20px;padding-bottom: 19px;border-bottom: 1px solid rgba(0,0,0,0.1);">
            <el-col :span="20" style="border: none;padding: 0">
            ...
            <el-col :span="4" style="border: none;padding: 0;">
              <div class="grid-content bg-purple">
                <el-button style="float: right" size="mini" type="primary"
                           @click="onSubmit(formInline,currentPage4,pageSize)">查询
                </el-button>
              </div>
            </el-col>
          </el-row>
          ...
          <div :class="!myStyles ? 'tableClass' : ''"
            ...
            <el-table ref="table" class="form1" :row-key="row_key" v-loading="loadings"
              ...
              <el-table-column label="操作" width="300px" :resizable="false">
                <template slot-scope="scope">
                  <el-button type="text" style="color:#32AFF0;marginLeft:6px;" @click="showInTable(scope.row)">浏览
                  </el-button>
                  <el-button type="text" style="color:#32AFF0;marginLeft:6px;" @click="showInDetails(scope.row)">详细
                  </el-button>
